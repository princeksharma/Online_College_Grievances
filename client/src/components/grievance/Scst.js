     ...
     return (
       ...
       <Form onSubmit={this.handleSubmit} onChange={this.handleChange} style={{ width: '1000px'}}>
        ...
        <h1 style={{ textAlign:'center', fontWeight: '20%', border:' 3px solid navy', color:'#660000'}}>Lodge Your Grievance</h1>
          <p className="lead"><h4>SC/ST Grievance Form</h4></p>
          <hr className="my-2" />
          <h6>Occasionally, students may face grievances related to reserved categories. AIACTR, Delhi has a formal grievance redressal committee which when intimidated by the student about the grievance would solve it as soon as possible.
